...
# Data paths
data_dir = Path(
    "/media/logan/NVMe_Storage/Data/nii_data/PROJECT_TASKFORCE/derivatives/models/preproc_sub-pilot01_ses-01_movietask.results"
)
...
run_files = [
    ...
    data_dir / "run05.nii.gz",
    data_dir / "run06.nii.gz",
    data_dir / "run07.nii.gz",
    data_dir / "run08.nii.gz",
    data_dir / "run09.nii.gz",
]
...
def slice_results(results, indices):
    ...
    if results.var_betas is not None:
