...
N_WORKERS = int(os.environ.get("FFS_BENCHMARK_PHASEPREP_WORKERS", 6))

HERE = os.path.dirname(os.path.abspath(__file__))
MAG_PATH = os.path.join(HERE, "method_direct_aligned.nii")
PHASE_PATH = os.path.join(HERE, "method_direct_aligned_phase.nii")
MASK_PATH = os.path.join(HERE, "automask.nii.gz")
