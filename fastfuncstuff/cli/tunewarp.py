...
def _epilog() -> str:
    ...
    lines += [
        ...
        "",
        "  Give -diag_only a -base and the warped IMAGES beside the labels and it",
        "  also scores lpa / mi / lncc against that base, so the table carries both",
        "  what we rank on and what the other tools were actually tuned for:",
        "",
        "  ffs_tunewarp -out cmp -diag_only 'ANTs SyN' -cohort ants_warped/ \\",
        "               -base MNI152_2009_template.nii.gz -metrics all",
        "",
