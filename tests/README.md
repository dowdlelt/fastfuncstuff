...
| `test_arma_glm.py`, `test_arma_glm_comprehensive.py`, `test_arma_core.py` | `glm.arma` -- ARMA prewhitening |
...
| `test_afni_io.py`, `test_afni_regression.py` | `io.afni` |
| `test_e2e_cli_workflows.py` | end-to-end CLI integration |
| `test_basic_workflow.py`, `test_high_level_confirmation.py` | high-level API |
