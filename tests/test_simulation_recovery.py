...
def _make_colored_noise(
    ...
    """
    from fastfuncsim.noise import generate_ar1_noise
...
def _build_design_and_signal(
    ...
    from fastfuncsim.design_builder import create_onset_matrix_microtime
...
class TestRidgeRecovery:
    ...
    def test_ridge_runs_without_error_close_isi(self):
        ...
        from fastfuncsim.ridge import fit_ridge_single_trial
