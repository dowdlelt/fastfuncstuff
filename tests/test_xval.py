...
Tests the core functions in fastfuncstuff/xval.py that compute
...
class TestSingleTrialCVHelper:
    ...
    def test_single_variant_equivalence(self):
        ...
        from fastfuncstuff.glm.xval import compute_xval_r2_single_trials, single_trial_cv_helper
    ...
    def test_multi_variant_shape(self):
        ...
        from fastfuncstuff.glm.xval import single_trial_cv_helper
